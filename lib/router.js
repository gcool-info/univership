...
Router.map(function() {
	this.route('home', {
		path: '/',
		waitOn: function() { return Meteor.subscribe('univerns') }
	});
});
...
Router.map(function() {
	...
	this.route('processEdit', {
		...
		data: function() { return Projects.findOne(this.params._id) },
		waitOn: function() { return [Meteor.subscribe('projects', this.params._id), Meteor.subscribe('processes'), Meteor.subscribe('projectfiles')] }
	});
